...
// ================================================================
// El dispositivo ESP8266 se conecta a tu red Wi-Fi local.
...
// ================================================================
// Modo calibración de sensores
// ================================================================
// Cuando CALIBRATION_MODE está en 1, el firmware entra en modo
// calibración: imprime en el Monitor Serie (115200 baud) cada
// CALIBRATION_SAMPLE_MS el valor RAW del ADC (y el % actual) junto con
// el Min/Max acumulados, para que puedas ajustar RAW_DRY / RAW_WET con
// lecturas reales de tu sensor.
//
// En modo calibración:
//   • El relé se mantiene DESACTIVADO (sin riego).
//   • No se publica telemetría MQTT (la presencia online sí se mantiene).
//   • El servidor web local sigue funcionando.
//
// Procedimiento:
//   1. Pon CALIBRATION_MODE 1 y sube el firmware.
//   2. Deja el sensor EN EL AIRE (seco): el RAW MAXIMO que veas en el
//      monitor será tu RAW_DRY.
//   3. Sumerge el sensor EN AGUA (húmedo): el RAW MINIMO será tu RAW_WET.
//   4. Anota ambos valores en RAW_DRY / RAW_WET y regresa
//      CALIBRATION_MODE a 0.
#define CALIBRATION_MODE      0          // 1 = modo calibración, 0 = normal
#define CALIBRATION_SAMPLE_MS 5000UL    // muestreo automático cada 5 s
...
//     Ejemplo: {"soil_humidity":{"raw":512,"unit":"%","value":51.5},
...
// Nota: el firmware le añade un sufijo con el chip ID (ej: "esp8266-3F2A1C")
// para evitar colisiones entre placas que compartan este config.h.
#define MQTT_CLIENT_ID   "esp8266"  // ID único por dispositivo
